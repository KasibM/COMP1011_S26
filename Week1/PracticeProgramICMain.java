...
class PracticeProgram {
    ...
    // code the overloaded method that takes two double parameters and returns their
    // product
...
public class PracticeProgramICMain {
    public static void main(String[] args) {
        ...
        System.out.println("Squares: " + Arrays.toString(PracticeProgram.generateSquares(5)));
        ...
        System.out.println( "Concatenation: " + demo.concatenate("Hello", " World"));
        ...
        System.out.println("Static Counter: " + newObj.staticCounter);
