...
public class Assignment1FitnessApp {
    ...
    public static void main(String[] args) {
        ...
        Workout w1 = new RunningWorkout("Alice", 30, 5.0);
        Workout w2 = new CyclingWorkout("Bob",45, 20.0);
        ...
        for ( Workout workout : workouts ){
            System.out.println();
            System.out.println("Workout Type: " + workout.getWorkoutType());
            workout.performWorkout();
            System.out.println("--------------------------------");
        }
        // TODO 17:
        // Create FitnessUtils object
        FitnessUtils sumUtils = new FitnessUtils();
        // Call both versions of logSummary()
        sumUtils.logSummary(100);
        sumUtils.logSummary(100, "Intermediate");
    }
}
